...
from WindTurbineBlade import WindTurbineBlade  # Assuming this module exists
...
class Rotor:
    ...
    def generated_energy(self, air_density: float, wind_speed: float, efficiency: float) -> float:
        """
        Calculates the energy generated by the entire rotor.
        ...
        :return: Power generated by the rotor (W).
        """
